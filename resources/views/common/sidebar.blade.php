<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
 ...
 {{--    @if(auth()->user()->hasRole('SuperAdmin') || auth()->user()->hasRole('Admin'))
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#packages"
            aria-expanded="true" aria-controls="packages">
            <i class="fas fa-box-open"></i>
            <span>Packages</span>
        </a>
        <div id="packages" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('packages.viewpackages') }}">Packages</a>
                <a class="collapse-item" href="{{ route('packages.createpackages') }}">Add New Package</a>
            </div>
        </div>
    </li>
   ...
   {{--  @if(auth()->user()->hasRole('SuperAdmin') || auth()->user()->hasRole('Admin'))
    ...
    <li class="nav-item">
        ...
        <div id="invoices" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('invoices.invoicelist') }}">View Invoices</a>
                <a class="collapse-item" href="{{ route('invoices.createinvoice') }}">Create Invoice</a>
            </div>
        </div>
    </li>
