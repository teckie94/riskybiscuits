    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <textarea class="form-control mt-2" form="staffRoleBidReject-{{ $staffrolebid->id }}" name="remarks" cols="40" rows="5" placeholder="Reason for rejection"></textarea>
            </div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                <form id="staffRoleBidReject-{{ $staffrolebid->id }}" method="POST" action="{{ route('staffrolebids.update', ['staffRoleBid' => $staffrolebid->id]) }}">
                    @csrf
                    @method('PUT')
