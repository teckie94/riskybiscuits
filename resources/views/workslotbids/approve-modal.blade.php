...
<div class="modal fade" id="approveModal{{ $workslotbid->id }}" tabindex="-1" role="dialog" aria-labelledby="approveModal"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Are you sure you want to approve Workslot Bid for {{ $users->find($workslotbid->user_id)->first_name . ' '. $users->find($workslotbid->user_id)->last_name}}?</div>
