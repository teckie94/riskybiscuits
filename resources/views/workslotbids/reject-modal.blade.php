...
<div class="modal fade" id="rejectModal{{ $workslotbid->id }}" tabindex="-1" role="dialog" aria-labelledby="rejectWorkslotModal"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Are you sure you want to reject Workslot Bid for {{ $users->find($workslotbid->user_id)->first_name . ' '. $users->find($workslotbid->user_id)->last_name}}?</div>
